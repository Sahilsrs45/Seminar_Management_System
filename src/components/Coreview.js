...
function App() {
  ...
  // Fetch pairs from the server on component mount
  useEffect(() => {
...
console.log(students)
  // Fetch students and guides from the server on component mount
  useEffect(() => {
